...
import 'package:mr_fix/core/api/help_center_api.dart';
        ...
        builder: (context, snapshot) {
          ...
          return ListView.separated(
              ...
              itemBuilder: (context, index) {
                final LegalDocumentsAndHelpCenterModel helpCenter =
                    LegalDocumentsAndHelpCenterModel.fromJson(
                        docs[index].data()! as Map<String, dynamic>);
                return CardInformationWidget(
                  title: helpCenter.title,
                  label: helpCenter.description,
                  data: Jiffy(helpCenter.createdAt.toString())
                      .format("dd MMMM yyy"),
                  onTap: () => LegalDocumentsController(context)
                      .detailDocument(helpCenter),
                );
              });
        },
      ),
